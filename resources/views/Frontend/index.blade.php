				...
				<div class="col-md-3 top_brand_left">
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							<div class="tag"><img src="{{asset('frontend_assets/images/tag.png')}}" alt=" " class="img-responsive" /></div>
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="{{asset('frontend_assets/images/1.png')}}" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="{{asset('frontend_assets/images/3.png')}}" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="{{asset('frontend_assets/images/2.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="{{('frontend_assets/images/4.png')}}" alt=" " class="img-responsive" /></a>
											<p>dogs food (4 Kg)</p>
